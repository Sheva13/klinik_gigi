...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('rekam_medis', function (Blueprint $table) {
            ...
            $table->string('no_identitas', 25)->nullable(); // Kolom ini di SQL kamu boleh NULL
            $table->integer('tipe_identitas')->nullable();
            $table->integer('status_nikah')->nullable();
            $table->integer('pekerjaan')->nullable();
            $table->text('alamat');
            $table->string('hp', 15);
            $table->string('golongan_darah', 1)->nullable(); // Di SQL kamu terlihat boleh NULL
            ...
            $table->string('jenis_kelamin', 1)->nullable(); // Di SQL kamu terlihat boleh NULL
